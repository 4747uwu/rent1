class SessionManager {
  ...
  // Store session data (Isolated per tab)
  setSession(token, user, expiresIn, organizationContext = null) {
    ...
    // This ensures data is stored ONLY for this specific tab.
    ...
    console.log('✅ Session stored (Tab Isolated):', { user: user.email, context: organizationContext });
  }
  ...
  // Clear session data
  clearSession() {
    // ✅ CHANGED: Clear only this tab's storage
