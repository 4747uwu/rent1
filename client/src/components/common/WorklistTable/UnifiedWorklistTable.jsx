        ...
        <td className="px-3 py-3.5 text-center border-r border-b border-slate-200 align-center" style={{ width: `${getColumnWidth('reporting')}px` }}>
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-1 max-w-[100px] mx-auto">
                        ...
                        {userAccountRoles.includes('verifier') && (
                            <>
                                ...
                                {/* ✅ BILLING BUTTON */}
                                <button
                                    className={`p-1 rounded transition-all hover:scale-110 ${study.billing?.isBilled
                                        ? 'bg-emerald-100 text-emerald-700 hover:bg-emerald-200'
                                        : 'hover:bg-emerald-50 text-gray-400 hover:text-emerald-600'
                                        }`}
                                    title={study.billing?.isBilled ? `Billing: ${study.billing.moduleName} \u2014 ${study.billing.currency} ${study.billing.amount}` : 'Set Billing'}
            ...
            {showBillingModal && (
                <StudyBillingModal
                    ...
                    onBillingSet={(billing) => {
                        // Optimistically update local study billing data
                        study.billing = billing;
                    }}
                />
            )}
        </tr>
...
const TableFooter = ({ pagination, onPageChange, onRecordsPerPageChange, displayedRecords, loading, queryCallNumber = '', onQueryCallNumberChange, isAdmin = false }) => {
    ...
    return (
        <div className="sticky bottom-0 bg-white border-t border-gray-200 px-3 py-1">
            <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-2 text-[10px] text-gray-600">
                    ...
                    <select
                        ...
                        className="px-1.5 py-0.5 text-[10px] font-medium bg-gray-50 border border-gray-200 rounded hover:border-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-400"
                    >
                ...
                <div className="flex items-center gap-1">
                    ...
                    <div className="flex items-center gap-1 text-[10px] text-gray-600">
                        ...
                        <input
                            ...
                            className="w-10 px-1 py-0.5 text-center text-[10px] border border-gray-200 rounded bg-white text-gray-900 focus:outline-none focus:ring-1 focus:ring-gray-400"
                        />
        ...
        <div className="w-full h-full flex flex-col bg-white rounded-xl shadow-lg border-2 border-gray-300">
            ...
            {studies.length > 0 && (
                <TableFooter
                    ...
                    onQueryCallNumberChange={onQueryCallNumberChange}
                    isAdmin={isAdmin}
                />
            )}
