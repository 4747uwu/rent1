...
// ✅ DIRECTLY EDITABLE FIELD - Looks like the image
...
// ✅ UPDATE SECTION WITH SAVE BUTTON
    ...
    const getStatusConfig = () => {
        switch (status) {
            ...
            case 'assigned_to_doctor':
                return { bg: 'bg-blue-100', text: 'text-blue-800', label: 'Assigned', dot: 'bg-blue-500' };
...
const StudyDetailedViewContent = ({ studyId, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-[9999] p-4">
            <div className="bg-gray-50 rounded-xl max-w-6xl w-full max-h-[95vh] overflow-hidden flex flex-col shadow-2xl">
                ...
                <div className="flex items-center justify-between px-6 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-blue-100 truncate max-w-md">
                            ...
                            {study.lab && (
                                <div className="bg-white rounded-lg border border-gray-300 overflow-hidden">
                                    <div className="bg-gray-100 px-4 py-3 border-b border-gray-200 flex items-center gap-2">
                                        ...
                                        <h3 className="font-semibold text-gray-800 text-sm">Laboratory Information</h3>
                                    </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-white rounded-lg border border-gray-300 overflow-hidden">
                                <div className="bg-gray-100 px-4 py-3 border-b border-gray-200 flex items-center gap-2">
                                    ...
                                    <h3 className="font-semibold text-gray-800 text-sm">Workflow Status</h3>
                                </div>
                                <div className="p-4 space-y-3">
                                    ...
                                    <div className="flex justify-between items-center">
                                        <span className="text-xs text-gray-600 font-medium">Report Available</span>
                                    ...
                                    <div className="flex justify-between items-center">
                                        <span className="text-xs text-gray-600 font-medium">Days Old</span>
                            ...
                            {study.assignments && study.assignments.length > 0 && (
                                <div className="bg-white rounded-lg border border-gray-300 overflow-hidden">
                                    <div className="bg-gray-100 px-4 py-3 border-b border-gray-200 flex items-center gap-2">
                                        ...
                                        <h3 className="font-semibold text-gray-800 text-sm">Assignments ({study.assignments.length})</h3>
                                    </div>
                            ...
                            <div className="bg-white rounded-lg border border-gray-300 overflow-hidden">
                                ...
                                <div className="p-4 space-y-2">
                                    ...
                                    <div className="flex justify-between items-center">
                                        <span className="text-xs text-gray-600 font-medium">Discussions</span>
                                        <span className="text-sm font-bold">{metadata?.discussionCount || 0}</span>
                                    </div>
                                    <div className="flex justify-between items-center">
                                        <span className="text-xs text-gray-600 font-medium">Status Changes</span>
                            ...
                            {relatedStudies?.length > 0 && (
                                <div className="bg-white rounded-lg border border-gray-300 overflow-hidden">
                                    <div className="bg-gray-100 px-4 py-3 border-b border-gray-200 flex items-center gap-2">
                                        ...
                                        <h3 className="font-semibold text-gray-800 text-sm">Related Studies ({relatedStudies.length})</h3>
                                    </div>
                                    <div className="p-4 space-y-2 max-h-48 overflow-y-auto">
                                        {relatedStudies.map((related) => (
                                            <div key={related._id} className="bg-gray-50 p-3 rounded border border-gray-200 hover:border-blue-300 transition-colors cursor-pointer">
