...
import DoctorTemplateDropdown from './DoctorTemplateDropdown'; // ✅ NEW
import AllTemplateDropdown from './AllTemplateDropdown'; // ✅ NEW
...
const OnlineReportingSystemWithOHIF = () => {
  ...
  // const [templateSelect, handleTemplateSelect] = useState(null)
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      {/* ✅ UPDATED: Top Control Bar with Template Dropdowns */}
      <div className="flex-shrink-0 bg-white border-b border-gray-200 shadow-sm">
        <div className="px-3 py-2">
          <div className="flex items-center justify-between gap-4">
            ...
            {/* ✅ NEW: Center Section - Template Dropdowns */}
            <div className="flex items-center space-x-3">
