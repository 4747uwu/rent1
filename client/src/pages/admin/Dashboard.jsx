...
const HEADER_COLOR_PRESETS = [
  ...
  { name: 'Amber', gradient: 'from-amber-700 via-amber-800 to-amber-900', textColor: 'text-white' },
  { name: 'Lime', gradient: 'from-lime-700 via-lime-800 to-lime-900', textColor: 'text-white' },
  { name: 'Rose', gradient: 'from-rose-700 via-rose-800 to-rose-900', textColor: 'text-white' },
  { name: 'Slate', gradient: 'from-slate-600 via-slate-700 to-slate-800', textColor: 'text-white' },
  { name: 'Emerald', gradient: 'from-emerald-700 via-emerald-800 to-emerald-900', textColor: 'text-white' },
  { name: 'Violet', gradient: 'from-violet-700 via-violet-800 to-violet-900', textColor: 'text-white' },
  { name: 'Sky', gradient: 'from-sky-600 via-sky-700 to-sky-800', textColor: 'text-white' },
  { name: 'Fuchsia', gradient: 'from-fuchsia-700 via-fuchsia-800 to-fuchsia-900', textColor: 'text-white' },
  { name: 'Zinc', gradient: 'from-zinc-600 via-zinc-700 to-zinc-800', textColor: 'text-white' },
  { name: 'Stone', gradient: 'from-stone-600 via-stone-700 to-stone-800', textColor: 'text-white' }
];
