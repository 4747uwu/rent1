...
currentCategory: {
  ...
  // Find the reportInfo section and ensure it's structured like this:
...
reportInfo: {
    ...
    // ✅ VERIFICATION INFO: Ensure this structure is correct
    verificationInfo: {
        verifiedBy: {
            type: mongoose.Schema.Types.ObjectId,
            ref: 'User', // ✅ Make sure this refs 'User' not 'Verifier'
            index: { sparse: true, background: true }
        },
        verifiedAt: {
            type: Date,
